...
public partial struct ZombieSimulationUpdateFOVSystem : ISystem
{
	...
	public partial struct UpdateFOVJob : IJobEntity
	{
		...
		[ReadOnly] public ZombieSimulationSettings Settings;
		[ReadOnly] public ZombieSimulationSpatialHashData SpatialHash;

		[BurstCompile]
		public void Execute([ChunkIndexInQuery] int chunkIndex, Entity entity, ref ZombieSimulationAgentFOVResults fovResults,
			in ZombieSimulationMovement movement, in LocalTransform localTransform)
		{
